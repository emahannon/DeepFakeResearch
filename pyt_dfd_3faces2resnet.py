...
print(device)
print("running with faces and face test set")
...
cl_imgs_lst += glob.glob('reals_part_9/*jpg')
cl_imgs_lst += glob.glob('reals_part_10/*jpg')
...
fk_imgs_lst += glob.glob('fakes_part_9/*jpg')
fk_imgs_lst += glob.glob('fakes_part_10/*jpg')
...
tst_imgs_rl = glob.glob('../test/reals_all/*jpg')
tst_label_rl = [1] * len(tst_imgs_rl)
tst_imgs_fk = glob.glob('../test/fakes_all/*jpg')
