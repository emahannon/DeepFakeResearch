...
print(device)
print("running with whole frames and whole frame test set")
print("running with resnet")
...
tst_imgs_rl = glob.glob('../test/frames_reals_all/*jpg')
tst_label_rl = [1] * len(tst_imgs_rl)
tst_imgs_fk = glob.glob('../test/frames_fakes_all/*jpg')
...
class df_data(Dataset):
	...
	def __getitem__(self, idx):
		...
		image = transform.resize(image, (256, 256), preserve_range=True, anti_aliasing=True)
