...
# 60007
cl_imgs_lst = glob.glob('frames_reals_2/*jpg')
# reals pt 0: 21410
cl_imgs_lst += glob.glob('frames_reals_0/*jpg')
cl_imgs_lst += glob.glob('frames_reals_1/*jpg')
cl_imgs_lst += glob.glob('frames_reals_3/*jpg')
cl_imgs_lst += glob.glob('frames_reals_4/*jpg')
#cl_imgs_lst += glob.glob('frames_reals_5/*jpg')
...
# these are the fakes
# 397557
fk_imgs_lst = glob.glob('frames_fakes_2/*jpg')
# fakes pt 0: 271815
fk_imgs_lst += glob.glob('frames_fakes_0/*jpg')
fk_imgs_lst += glob.glob('frames_fakes_1/*jpg')
fk_imgs_lst += glob.glob('frames_fakes_3/*jpg')
fk_imgs_lst += glob.glob('frames_fakes_4/*jpg')
#fk_imgs_lst += glob.glob('frames_fakes_5/*jpg')
...
print(len(fk_imgs_lst) + len(cl_imgs_lst))
...
tst_imgs_rl = glob.glob('frames_reals_5/*jpg')
#glob.glob('../test/reals_all')
tst_label_rl = [1] * len(tst_imgs_rl)
tst_imgs_fk = glob.glob('frames_fakes_5/*jpg')
#glob.glob('../test/fakes_all')
...
for epoch in range(5):  # loop over the dataset multiple times
	...
	#for i, data in enumerate(testloader):
		...
		inputs = inputs.permute(0,1,2,3).float().to(device) # put img on gpu
...
with torch.no_grad():
	for i, data in enumerate(testloader):
		inputs = data['image'].to(device)
		labels = data['lbl'].to(device)
		inputs = inputs.permute(0,1,3,2).float().to(device) # put img on gpu
